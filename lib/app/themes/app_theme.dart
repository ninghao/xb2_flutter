...
const textThemeDark = TextTheme(
  bodyLarge: TextStyle(color: primaryTextColorDark),
...
// SnackBar 主题
const snackBarTheme = SnackBarThemeData(backgroundColor: Colors.black87);

const snackBarThemeDark = SnackBarThemeData(
  backgroundColor: Colors.black87,
  contentTextStyle: TextStyle(color: primaryTextColorDark),
);
