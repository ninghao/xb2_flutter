    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(child: Text('发送请求'), onPressed: getUser),
          ElevatedButton(child: Text('创建用户'), onPressed: createUser),
          ElevatedButton(child: Text('用户登录'), onPressed: login),
          ElevatedButton(child: Text('更新用户'), onPressed: updateUser),
        ],
      ),
    );
  }
